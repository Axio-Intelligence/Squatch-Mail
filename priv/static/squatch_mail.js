(() => {
  ...
  var EntryUploader = class {
    ...
    readNextChunk() {
      ...
      reader.onload = (e) => {
        var _a3, _b;
        if (((_a3 = e.target) == null ? void 0 : _a3.error) === null) {
    ...
    mergeAttrs(target, source, opts = {}) {
      ...
      for (let i = sourceAttrs.length - 1; i >= 0; i--) {
        ...
        if (!exclude.has(name)) {
          ...
          if (name === "value") {
            const sourceValue = (_a3 = source.value) != null ? _a3 : source.getAttribute(name);
...
`
  ...
  var DOMPatch = class {
    constructor(view, container, html, streams, targetCID, opts = {}) {
      ...
      this.undoRef = (_a3 = opts.undoRef) != null ? _a3 : null;
    }
      ...
      const morph = (targetContainer2, source, withChildren = this.withChildren) => {
        const morphCallbacks = {
          ...
          onBeforeNodeAdded: (el) => {
            ...
            if (((_a3 = this.getStreamInsert(el)) == null ? void 0 : _a3.updateOnly) && !this.streamComponentRestore[el.id]) {
              return false;
            }
          ...
          onBeforeNodeDiscarded: (el) => {
            ...
            if (dom_default.isPortalTemplate(el)) {
              const teleportedEl = document.getElementById(
                ((_a3 = el.content.firstElementChild) == null ? void 0 : _a3.id) || ""
              );
              if (teleportedEl) {
                teleportedEl.remove();
    ...
    handleRuntimeHook(el, source) {
      ...
      if (el.hasAttribute("nonce")) {
        ...
        nonce = (_b = (_a3 = template.content.querySelector(`script[${PHX_RUNTIME_HOOK}="${CSS.escape(name)}"]`)) == null ? void 0 : _a3.getAttribute("nonce")) != null ? _b : null;
      }
  ...
  var View = class _View {
    ...
    constructor(el, liveSocket2, parentView, flash = null, liveReferer = null) {
      ...
      this.channel = this.liveSocket.channel(`lv:${this.id}`, () => {
        ...
        return {
          ...
          flash: (_a3 = this.flash) != null ? _a3 : void 0,
    ...
    maybeRecoverForms(html, callback) {
      ...
      dom_default.all(template.content, `[${PHX_PORTAL}]`).forEach((portalTemplate) => {
        ...
        (_a4 = template.content.firstElementChild) == null ? void 0 : _a4.appendChild(
      ...
      rootEl.setAttribute(PHX_STATIC, (_a3 = this.getStatic()) != null ? _a3 : "");
    ...
    getDescendentByEl(el) {
      ...
      if (el.id === this.id) {
        ...
        return this.children && ((_a3 = this.children[el.getAttribute(PHX_PARENT_ID)]) == null ? void 0 : _a3[el.id]);
      }
    }
    ...
    joinDeadView() {
      ...
      if (body && !this.isPhxView(body) && !this.isPhxView(document.firstElementChild)) {
        ...
        window.requestAnimationFrame(() => {
          var _a3;
          view.execNewMounted();
          this.maybeScroll((_a3 = history.state) == null ? void 0 : _a3.scroll);
        });
      }
    }
    /** @internal */
  ...
  // js/squatch_mail.js
  var _a;
  var csrfToken = (_a = document.querySelector("meta[name='squatch-mail-csrf-token']")) == null ? void 0 : _a.getAttribute("content");
  var _a2;
  var socketPath = ((_a2 = document.querySelector("meta[name='squatch-mail-socket-path']")) == null ? void 0 : _a2.getAttribute("content")) || "/live";
